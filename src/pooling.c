...
void calcPad(poolingOrdem,height,width)
    int poolingOrdem, height, width;
{
    ...
    pixel *imagem, *matriz;
{
    ...
    int posicao = y*width + x,posicaoPool = 0;
