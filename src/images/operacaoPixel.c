...
#include <malloc.h>
#include <string.h>
#include "../include/images/operacaoPixel.h"
...
pixel igualarCorPixel(int valor, pixel* p)
{
    (*p).blue  = valor; /* A cor azul assume o valor passado */
    (*p).green = valor; /* A cor verde assume o valor passado */
    (*p).red   = valor; /* A cor vermelha assume o valor passado */
}
...
pixel maiorCordoPixel(pixel entrada)
{
    ...
    pixel* retorno;
    igualarCorPixel(maiorValor, &retorno);
